/**
 * This is step 2, the blockstack service that was initiated with the button click has returned an authentication response
...
window.validate = function() {
	...
	BlockstackCommon.isSignedIn().then(function(data) {
...
function process(data) {
	...
	// Using an inline MD5 function for now
